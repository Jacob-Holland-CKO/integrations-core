...
def test():
    ...
    assert instance_model_contents == normalize_yaml(
        ...
        class InstanceConfig(BaseModel):
            ...
            def _ensure_default_settings(cls, v, field):
                return defaults.instance_settings(field, v) if v is None else v
            ...
            def _validate_settings(cls, v, field):
                return getattr(validators, 'instance_settings', identity)(v, field=field)
